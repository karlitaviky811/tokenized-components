...
- Path: C:\Users\ktovar\myorg\lib-ui\.agents\skills\angular-best-practices\SKILL.md
- Rules:
...
- Path: C:\Users\ktovar\myorg\lib-ui\.agents\skills\angular-best-practices-material\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.
...
### clean-css
- Path: C:\Users\ktovar\myorg\lib-ui\.agents\skills\clean-css\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.
...
### find-skills
- Path: C:\Users\ktovar\.agents\skills\find-skills\SKILL.md
